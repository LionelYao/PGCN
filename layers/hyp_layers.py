...
class HNNLayer(nn.Module):
    ...
    def __init__(self, manifold, in_features, out_features, c, dropout, act, use_bias):
        ...
        #print("features", in_features, out_features)
        #print(manifold.space_dim, manifold.time_dim)
...
class HypLinear(nn.Module):
    ...
    def forward(self, x):
        ...
        print("forw dim",self.manifold.time_dim,self.manifold.dim,"feat",self.in_features,self.out_features)
