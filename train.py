...
def train(args):
    ...
    # for g in optimizer
    if args.model == 'PMLP' and args.task == 'nc':
        pass
    ...
    for epoch in range(args.epochs):
        ...
        if torch.isnan(embeddings).any():
            print("NaN detected in embeddings before compute_metrics at epoch:", epoch)
...
if __name__ == '__main__':
    ...
    args.manifold_list = args.manifold_list.split(',')
    args.time_dim_list =  list(map(int, args.time_dim_list.split(',')))
    args.space_dim_list = list(map(int, args.space_dim_list.split(',')))
    args.dim_list = [args.time_dim_list[i] + args.space_dim_list[i] for i in range(len(args.time_dim_list))] #list(map(int, args.dim_list.split(',')))
    train(args)
