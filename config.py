...
config_args = {
    ...
    'model_config': {
        ...
        'manifold_list':('PseudoHyperboloid,PseudoHyperboloid','which manifolds to use in the ProductManifold, can be any of [Euclidean, Hyperboloid, PoincareBall, PseudoHyperboloid]'),
        'dim_list':('5,10','The dimension of manifolds to use in the ProductManifold'),
        'time_dim_list':('2,2','The time dimension of manifolds to use in the ProductManifold'),
        'space_dim_list':('10,10','The space dimension of manifolds to use in the ProductManifold')
    },
    'data_config': {
